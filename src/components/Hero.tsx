...
export function Hero() {
  return (
    <div className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center bg-background pt-20">
      ...
      <div className="relative flex items-center justify-center w-full max-w-2xl aspect-square mb-8">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-20">
          <motion.svg
            ...
            animate={{ scale: [0.8, 1.05, 1], opacity: [0, 0.4, 0.15] }}
      ...
      <div className="relative z-10 text-center flex flex-col items-center justify-center px-4">
        ...
        <motion.p
          ...
          className="text-sm md:text-base text-text-muted font-sans font-light tracking-[0.2em] max-w-2xl uppercase"
        >
